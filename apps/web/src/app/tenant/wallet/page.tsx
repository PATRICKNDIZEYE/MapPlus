...
export default function TenantWalletPage() {
  ...
  if (balance.isLoading) {
    return <div className="px-8 py-7 min-h-[60vh] flex items-center justify-center"><BrandedLoader size="lg" label="Loading wallet…" /></div>;
  }
        ...
        <div className="lg:col-span-3">
          <div className="card overflow-hidden">
            ...
            {transactions.isLoading ? (
              <div className="min-h-[220px] flex flex-col items-center justify-center"><BrandedLoader size="md" label="Loading transactions…" /></div>
