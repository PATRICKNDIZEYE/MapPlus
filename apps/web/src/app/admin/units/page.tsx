...
import type { UnitFeatureProperties } from '@mapplus/shared';
import { Badge } from '@/components/ui/Badge';
import { FloorPlanViewer, FloorPlanLegend, type ViewMode as FloorPlanViewMode } from '@/components/admin/FloorPlanViewer';
              ...
              <div className="px-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {selected.status === 'vacant' ? (
                    <button className="btn-primary text-xs py-1.5 justify-center col-span-2">
                      Assign tenant
                    </button>
                  ) : (
                    <>
