...
import type { organizations, buildings, floors, units, tenants, shopProfiles, products, navNodes, navEdges, qrAnchors, mapVersions, amenities, analyticsEvents, users, wrongInfoReports } from '../schema';
...
export type UserRole = 'super_admin' | 'org_owner' | 'building_manager' | 'floor_manager' | 'tenant_admin' | 'tenant_staff' | 'public';
